...
<%@page import="com.app.login.POJO.ContactBook" %>
<%@page import="com.app.login.DAO.ContactBookDAO" %>
									...
									<div class="form-group">
										...
										<div class="col-lg-4">
											<input type="text" placeholder="landlineno"
												value="<%=!newData ? pdetails.getLandno() : ""%>"
			...
			for (ContactBook pd : data) {
               %>						
										<tr class="gradeX">
			                                ...
			                                <td class="center"><%=pd.getLandno() + "" != "0" ? pd.getLandno() : "-"%></td>
											<th><a
